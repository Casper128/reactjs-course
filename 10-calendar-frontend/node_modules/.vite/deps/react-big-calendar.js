...
function useRootClose(ref, onRootClose, _temp) {
  ...
  var preventMouseRootCloseRef = (0, import_react10.useRef)(false);
  var onClose = onRootClose || noop3;
  var handleMouseCapture = (0, import_react10.useCallback)(function(e) {
...
function mergeOptionsWithPopperConfig(_ref) {
  ...
  var enabled = _ref.enabled, enableEvents = _ref.enableEvents, placement = _ref.placement, flip = _ref.flip, offset2 = _ref.offset, containerPadding = _ref.containerPadding, arrowElement = _ref.arrowElement, _ref$popperConfig = _ref.popperConfig, popperConfig = _ref$popperConfig === void 0 ? {} : _ref$popperConfig;
...
// node_modules/react-overlays/esm/Overlay.js
var Overlay = import_react12.default.forwardRef(function(props, outerRef) {
  ...
  var _useState = (0, import_react12.useState)(!props.show), exited = _useState[0], setExited = _useState[1];
  ...
  if (Transition) {
    ...
    child = import_react12.default.createElement(Transition, {
      "in": props.show,
      appear: true,
      onExit,
      onExiting,
...
import_prop_types2.default.oneOfType([import_prop_types2.default.string, import_prop_types2.default.func]);
import_prop_types2.default.any;
import_prop_types2.default.func;
import_prop_types2.default.oneOfType([import_prop_types2.default.arrayOf(import_prop_types2.default.oneOf(viewNames$1)), import_prop_types2.default.objectOf(function(prop, key) {
  ...
  if (isBuiltinView) {
    ...
    return import_prop_types2.default.elementType.apply(import_prop_types2.default, [prop, key].concat(args));
  }
})]);
import_prop_types2.default.oneOfType([import_prop_types2.default.oneOf(["overlap", "no-overlap"]), import_prop_types2.default.func]);
...
var localePropType = import_prop_types2.default.oneOfType([import_prop_types2.default.string, import_prop_types2.default.func]);
...
var Popup = function(_React$Component) {
  _inherits(Popup2, _React$Component);
  var _super = _createSuper(Popup2);
  function Popup2() {
  ...
  _createClass(Popup2, [{
    ...
    value: function componentDidMount() {
      var _this$props = this.props, _this$props$popupOffs = _this$props.popupOffset, popupOffset = _this$props$popupOffs === void 0 ? 5 : _this$props$popupOffs, popperRef = _this$props.popperRef, _getOffset = offset(popperRef.current), top = _getOffset.top, left = _getOffset.left, width = _getOffset.width, height2 = _getOffset.height, viewBottom = window.innerHeight + scrollTop_default(window), viewRight = window.innerWidth + scrollLeft_default(window), bottom = top + height2, right = left + width;
    ...
    value: function render() {
      ...
      return import_react13.default.createElement("div", {
        style: _objectSpread2(_objectSpread2({}, this.props.style), style2),
...
var Popup$1 = import_react13.default.forwardRef(function(props, ref) {
  return import_react13.default.createElement(Popup, Object.assign({
    popperRef: ref
  }, props));
});
...
var Selection = function() {
  function Selection2(node) {
    var _ref2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, _ref2$global = _ref2.global, global2 = _ref2$global === void 0 ? false : _ref2$global, _ref2$longPressThresh = _ref2.longPressThreshold, longPressThreshold = _ref2$longPressThresh === void 0 ? 250 : _ref2$longPressThresh;
...
var BackgroundCells = function(_React$Component) {
  ...
  _createClass(BackgroundCells2, [{
    ...
    value: function _selectable() {
      var _this2 = this;
      var node = (0, import_react_dom3.findDOMNode)(this);
      var selector = this._selector = new Selection(this.props.container, {
        longPressThreshold: this.props.longPressThreshold
      });
      var selectorClicksHandler = function selectorClicksHandler2(point, actionType) {
        if (!isEvent((0, import_react_dom3.findDOMNode)(_this2), point)) {
      ...
      selector.on("beforeSelect", function(box) {
        if (_this2.props.selectable !== "ignoreEvents")
          return;
        return !isEvent((0, import_react_dom3.findDOMNode)(_this2), box);
      });
...
var EventRowMixin = {
  propTypes: {
    slotMetrics: import_prop_types2.default.object.isRequired,
    selected: import_prop_types2.default.object,
    isAllDay: import_prop_types2.default.bool,
    accessors: import_prop_types2.default.object.isRequired,
    localizer: import_prop_types2.default.object.isRequired,
    components: import_prop_types2.default.object.isRequired,
    getters: import_prop_types2.default.object.isRequired,
...
var DateContentRow = function(_React$Component) {
  ...
  function DateContentRow2() {
    ...
    _this.handleShowMore = function(slot, target) {
      ...
      var row = qsa((0, import_react_dom3.findDOMNode)(_assertThisInitialized(_this)), ".rbc-row-bg")[0];
      var cell;
      if (row)
    ...
    _this.getContainer = function() {
      ...
      return container ? container() : (0, import_react_dom3.findDOMNode)(_assertThisInitialized(_this));
    };
    ...
    _this.renderDummy = function() {
      ...
      }, range3.map(_this.renderHeadingCell)), import_react13.default.createElement("div", {
        className: "rbc-row",
  ...
  _createClass(DateContentRow2, [{
    ...
    value: function getRowLimit() {
      ...
      var eventSpace = height((0, import_react_dom3.findDOMNode)(this)) - headingHeight;
    ...
    value: function render() {
      ...
      }, range3.map(this.renderHeadingCell)), import_react13.default.createElement(ScrollableWeekComponent, null, import_react13.default.createElement(WeekWrapper, Object.assign({
        isAllDay
...
var MonthView = function(_React$Component) {
  ...
  function MonthView2() {
    ...
    _this.getContainer = function() {
      return (0, import_react_dom3.findDOMNode)(_assertThisInitialized(_this));
    };
    ...
    _this.handleShowMore = function(events, date2, cell, slot, target) {
      ...
      _this.clearSelection();
      if (popup) {
        var position2 = position(cell, (0, import_react_dom3.findDOMNode)(_assertThisInitialized(_this)));
        _this.setState({
          overlay: {
            date: date2,
            events,
    ...
    _this.slotRowRef = import_react13.default.createRef();
    _this.state = {
      rowLimit: 5,
  ...
  _createClass(MonthView2, [{
    ...
    value: function renderHeaders(row) {
      var _this$props6 = this.props, localizer = _this$props6.localizer, components2 = _this$props6.components;
      var first = row[0];
    ...
    value: function renderOverlay() {
      ...
      var _this$props7 = this.props, accessors = _this$props7.accessors, localizer = _this$props7.localizer, components2 = _this$props7.components, getters = _this$props7.getters, selected = _this$props7.selected, popupOffset = _this$props7.popupOffset;
      return import_react13.default.createElement(Overlay_default, {
        ...
        return import_react13.default.createElement(Popup$1, Object.assign({}, props, {
          popupOffset,
          accessors,
          getters,
          selected,
...
var DayColumn = function(_React$Component) {
  ...
  function DayColumn2() {
    ...
    _this._selectable = function() {
      var node = (0, import_react_dom3.findDOMNode)(_assertThisInitialized(_this));
      ...
      var selectorClicksHandler = function selectorClicksHandler2(box, actionType) {
        if (!isEvent((0, import_react_dom3.findDOMNode)(_assertThisInitialized(_this)), box)) {
      ...
      selector.on("beforeSelect", function(box) {
        if (_this.props.selectable !== "ignoreEvents")
          return;
        return !isEvent((0, import_react_dom3.findDOMNode)(_assertThisInitialized(_this)), box);
      });
  ...
  _createClass(DayColumn2, [{
    ...
    value: function render() {
      ...
      var DayColumnWrapperComponent = components2.dayColumnWrapper || DayColumnWrapper;
...
var TimeGutter = function(_Component) {
  _inherits(TimeGutter2, _Component);
  var _super = _createSuper(TimeGutter2);
  function TimeGutter2() {
    var _this;
    _classCallCheck(this, TimeGutter2);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _super.call.apply(_super, [this].concat(args));
    ...
    }), start = _adjustForDST.start, end = _adjustForDST.end;
  ...
  _createClass(TimeGutter2, [{
    key: "UNSAFE_componentWillReceiveProps",
    value: function UNSAFE_componentWillReceiveProps(nextProps) {
      var min2 = nextProps.min, max2 = nextProps.max, localizer = nextProps.localizer;
      var _adjustForDST2 = adjustForDST({
        min: min2,
        max: max2,
        localizer
      }), start = _adjustForDST2.start, end = _adjustForDST2.end;
    ...
    value: function render() {
      var _this2 = this;
      var _this$props3 = this.props, resource = _this$props3.resource, components2 = _this$props3.components, getters = _this$props3.getters;
      return import_react13.default.createElement("div", {
  ...
  _createClass(TimeGridHeader2, [{
    ...
    value: function render() {
      ...
      return import_react13.default.createElement("div", {
        ...
        }, _this3.renderHeaderCells(range3)), import_react13.default.createElement(DateContentRow, {
          isAllDay: true,
          rtl,
          getNow: getNow2,
          minRows: 2,
...
var TimeGrid = function(_Component) {
  ...
  function TimeGrid2(props) {
    ...
    _this.gutterRef = function(ref) {
      _this.gutter = ref && (0, import_react_dom3.findDOMNode)(ref);
    };
  ...
  _createClass(TimeGrid2, [{
    ...
    value: function render() {
      ...
      }, import_react13.default.createElement(TimeGutter, {
        date: start,
        ref: this.gutterRef,
        localizer,
